...
concateImg1 = np.concatenate((positiveImg1,positiveImg2),axis=1)	# Concatenate two images horizontally	
concateImg2 = np.concatenate((negativeImg1,negativeImg2), axis=1)	
concateImg3 = np.concatenate((concateImg1,concateImg2), axis=0)		# Concatenate two images vertically
concateImg4 = np.concatenate((concateImg3,concateImg3), axis=1)		# Concatenate two images after adding two images

print('size of concateImg4: {}'.format(concateImg4.shape))				 

title = 'Fruits~Bench'							# Set title
